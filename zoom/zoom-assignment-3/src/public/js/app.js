...
socket.on("welcome", async () => {
  ...
  peerStream.style.transform = "none";
...
socket.on("bye", () => {
  ...
  peerFace.src = "";
  peerStream.style.transform = "translateX(200vw)";
  chat.style.transform = "translateY(200vh)";
});
